...
const Contact = () => {
  return (
    <>
      <section className="con bg-white px-3 py-20 lg:py-[120px] overflow-hidden relative z-10">
          ...
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="mb-12 max-w-[570px] lg:mb-0">
              ...
              <p className="text-base leading-relaxed mb-9 text-body-color">
                У нас есть команда специалистов, которые всегда готовы помочь
                вам! Если у вас возникли вопросы, предложения или вы просто
                хотите пообщаться, пожалуйста, свяжитесь с нами. Мы ценим
                обратную связь и стремимся обеспечить отличный уровень
                обслуживания каждому нашему клиенту.
              </p>
              ...
              <div className="mb-8 flex w-full max-w-[370px]">
                ...
                <div className="w-full">
                  ...
                  <p className="text-base text-body-color">+7 918 392 33 28</p>
                </div>
              </div>
              <div className="mb-8 flex w-full max-w-[370px]">
                <div className="mr-6 flex h-[60px] w-full max-w-[60px] items-center justify-center overflow-hidden rounded bg-primary bg-opacity-5 text-primary sm:h-[70px] sm:max-w-[70px]">
